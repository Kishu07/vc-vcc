...
async def load_start():
    ...
    if restart_data:
        print("[INFO]: SENDING RESTART STATUS TO ARC SERVER")
        try:
    ...
    await client.send_message(LOG_GROUP_ID, "Assistant Of arc Music Started")
    print("[INFO]: STARTED THE ARC BOT AND SENDING THE INFO TO ARC SERVER")
