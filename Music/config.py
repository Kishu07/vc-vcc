...
SUDO_USERS = list(map(int, getenv('SUDO_USERS', '5058700158').split()))
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", ''))
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "THE_ARC_MUSIC")
ZAID_SUPPORT = getenv("ZAID_SUPPORT", "THE_ARC_MUSIC")
